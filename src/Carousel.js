...
export default class Carousel extends React.Component {
  render() {
    ...
    const images = [
      ...
      ['http://cyb.no/2016-assets/baal-fikset.jpg', 'Hyttetur for interne er noe vi også tilbyr.'],
      ...
      ['http://cyb.no/2016-assets/foredragi-fikset.jpg', 'Vi arrangerer også foredrag med faglig innhold.'],
      ['http://cyb.no/2016-assets/isbading-fikset.jpg', 'En staut gjeng som badet ute i november.'],
      ['http://cyb.no/2016-assets/kafe-fikset.jpg', 'Ønsker du å være en barista? Vi trenger alltid folk.'],
      ['http://cyb.no/2016-assets/konsert-fikset.jpg', 'Jubileumskonser.'],
    ]
